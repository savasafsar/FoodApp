...
import com.example.foodapp.fragment.MainActivity
import com.example.foodapp.fragment.MealActivity
...
class MealBottomSheetFragment : BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        onBottomShetDialogClick()


    }

    private fun onBottomShetDialogClick() {
    ...
    private fun observeBottomSheetMeal() {
       viewModel.observeBottomSheetMeal().observe(viewLifecycleOwner, Observer { meal->
           ...
           binding.tvBottomSheetCa.text = meal.strCategory
